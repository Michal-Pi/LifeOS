...
- `users/{userId}/runs/{runId}/workflowSteps` - Graph workflow steps (Phase 6E)
...
- `apps/web-vite/src/hooks/useWorkflowSteps.ts` - Workflow step stream (Phase 6E)
- `apps/web-vite/src/agents/builtinTools.ts` - Built-in tool metadata (Phase 6C)
- `apps/web-vite/src/components/agents/RunCard.tsx` - Resume + human-input prompt (Phase 6A/6E)
