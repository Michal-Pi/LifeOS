/**
 * TemplatesTab — Workflow blueprints and workflow templates.
 *
 * Agent templates and prompt library have moved to AgentsTab.
 */
...
import type { Workflow, WorkflowTemplate } from '@lifeos/agents'
